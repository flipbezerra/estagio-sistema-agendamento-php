<?php
    ...
    if ($stmt->execute()) 
    {
        ...
        $retorna = ['sit' => false, 'msg' => '<div class="alert alert-success" role="alert">Erro na criação da solicitação. <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'];
    }
